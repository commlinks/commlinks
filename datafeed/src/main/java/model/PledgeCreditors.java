...
@XmlRootElement(name = "PledgeCreditors", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class PledgeCreditors {

    @XmlElement(name = "PledgeCreditor", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
