...
@XmlRootElement(name = "SecuredClaimReason", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class SecuredClaimReason {

    @XmlElement(name = "Description207", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String description207;
    @XmlElement(name = "ReasonDate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
