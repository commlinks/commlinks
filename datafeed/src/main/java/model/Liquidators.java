...
@XmlRootElement(name = "Liquidators", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Liquidators {

    @XmlElement(name = "Liquidator", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
