...
@XmlRootElement(name = "StatementsN", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsN {

    @XmlElement(name = "StatementN", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
