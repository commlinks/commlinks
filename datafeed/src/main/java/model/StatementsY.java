...
@XmlRootElement(name = "StatementsY", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsY {

    @XmlElement(name = "StatementY", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
