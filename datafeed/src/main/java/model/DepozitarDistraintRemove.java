...
@XmlRootElement(name = "DepozitarDistraintRemove", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class DepozitarDistraintRemove {

    @XmlElement(name = "Court", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String court;
    @XmlElement(name = "CaseNo", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
