...
@XmlRootElement(name = "Successors703", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Successors703 {

    @XmlElement(name = "Successor703", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
