...
@XmlRootElement(name = "ReinstatementsDisallowPetitionSecIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class ReinstatementsDisallowPetitionSecIns {

    @XmlElement(name = "ReinstatementDisallowPetitionSecIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
