...
@XmlRootElement(name = "SupervisionBodyFullThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class SupervisionBodyFullThirdIns {

    @XmlElement(name = "SupervisionBodyMemberFullThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class SupervisionBodyMemberFullThirdIns {
        ...
        @XmlElement(name = "EntryType", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
