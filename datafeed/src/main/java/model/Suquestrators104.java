...
@XmlRootElement(name = "Suquestrators104", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Suquestrators104 {

    @XmlElement(name = "Suquestrator104", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class Suquestrator104 {
        ...
        @XmlElement(name = "AppointedTill", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
