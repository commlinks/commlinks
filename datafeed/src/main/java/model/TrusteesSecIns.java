...
@XmlRootElement(name = "TrusteesSecIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class TrusteesSecIns {

    @XmlElement(name = "TrusteeSecIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
