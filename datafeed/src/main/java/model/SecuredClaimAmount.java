...
@XmlRootElement(name = "SecuredClaimAmount", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class SecuredClaimAmount {

    @XmlElement(name = "AmountDue", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String amountDue;
    @XmlElement(name = "Units", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
