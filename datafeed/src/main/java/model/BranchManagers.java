...
@XmlRootElement(name = "BranchManagers", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class BranchManagers {

    @XmlElement(name = "BranchManager", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class BranchManager {
        ...
        @XmlElement(name = "Passport", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
