...
@XmlRootElement(name = "StatementsB", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsB {

    @XmlElement(name = "StatementB", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
