...
@XmlRootElement(name = "StatementsAL", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAL {

    @XmlElement(name = "StatementAL", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
