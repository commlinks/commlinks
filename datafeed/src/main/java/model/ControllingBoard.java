...
@XmlRootElement(name = "ControllingBoard", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class ControllingBoard {

    @XmlElement(name = "ControllingBoardMandate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected ControllingBoard.ControllingBoardMandate controllingBoardMandate;
    @XmlElement(name = "ControllingBoardPerson", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
