...
@XmlRootElement(name = "StatementsA", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsA {

    @XmlElement(name = "StatementA", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
