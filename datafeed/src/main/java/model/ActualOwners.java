...
@XmlRootElement(name = "ActualOwners", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class ActualOwners {

    @XmlElement(name = "ActualOwner", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
