...
@XmlRootElement(name = "StatementsW", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsW {

    @XmlElement(name = "StatementW", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
