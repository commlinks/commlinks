...
@XmlRootElement(name = "Suquestrators113", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Suquestrators113 {

    @XmlElement(name = "Suquestrator113", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
