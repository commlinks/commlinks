...
@XmlRootElement(name = "StatementsI", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsI {

    @XmlElement(name = "StatementI", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
