...
@XmlRootElement(name = "StatementsP", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsP {

    @XmlElement(name = "StatementP", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
