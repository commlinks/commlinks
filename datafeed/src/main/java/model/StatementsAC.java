...
@XmlRootElement(name = "StatementsAC", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAC {

    @XmlElement(name = "StatementAC", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
