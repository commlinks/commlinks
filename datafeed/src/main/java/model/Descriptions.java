...
@XmlRootElement(name = "Descriptions", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Descriptions {

    @XmlElement(name = "DescriptionCount", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected Descriptions.DescriptionCount descriptionCount;
    @XmlElement(name = "Description406", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
