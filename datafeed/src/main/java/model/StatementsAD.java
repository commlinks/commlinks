...
@XmlRootElement(name = "StatementsAD", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAD {

    @XmlElement(name = "StatementAD", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
