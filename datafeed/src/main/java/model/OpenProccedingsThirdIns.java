...
@XmlRootElement(name = "OpenProccedingsThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class OpenProccedingsThirdIns {
    ...
    @XmlElement(name = "RuleCheckBox", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
