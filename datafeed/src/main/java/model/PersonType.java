...
@XmlType(name = "PersonType", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", propOrder = {
    "indent",
    "name",
    "indentType",
    "countryID",
...
public class PersonType {
    ...
    @XmlElement(name = "Indent", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String indent;
    @XmlElement(name = "Name", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String name;
    @XmlElement(name = "IndentType", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String indentType;
    @XmlElement(name = "CountryID", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true, type = Long.class, nillable = true)
    protected Long countryID;
    @XmlElement(name = "CountryName", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
