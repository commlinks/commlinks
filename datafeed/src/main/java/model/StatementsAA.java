...
@XmlRootElement(name = "StatementsAA", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAA {

    @XmlElement(name = "StatementAA", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
