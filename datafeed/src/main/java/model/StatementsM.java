...
@XmlRootElement(name = "StatementsM", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsM {

    @XmlElement(name = "StatementM", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
