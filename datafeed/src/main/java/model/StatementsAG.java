...
@XmlRootElement(name = "StatementsAG", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAG {

    @XmlElement(name = "StatementAG", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
