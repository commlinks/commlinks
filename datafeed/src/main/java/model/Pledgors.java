...
@XmlRootElement(name = "Pledgors", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Pledgors {

    @XmlElement(name = "Pledgor", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
