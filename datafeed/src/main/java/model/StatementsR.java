...
@XmlRootElement(name = "StatementsR", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsR {

    @XmlElement(name = "StatementR", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
