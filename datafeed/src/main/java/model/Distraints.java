...
@XmlRootElement(name = "Distraints", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Distraints {

    @XmlElement(name = "Distraint", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
