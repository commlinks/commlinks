...
@XmlRootElement(name = "Managers", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Managers {

    @XmlElement(name = "Manager", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
