...
@XmlRootElement(name = "StatementsAE", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAE {

    @XmlElement(name = "StatementAE", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
