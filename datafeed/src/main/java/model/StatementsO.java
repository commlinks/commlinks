...
@XmlRootElement(name = "StatementsO", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsO {

    @XmlElement(name = "StatementO", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
