...
@XmlRootElement(name = "StatementsAI", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAI {

    @XmlElement(name = "StatementAI", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
