...
@XmlRootElement(name = "StatementsAJ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAJ {

    @XmlElement(name = "StatementAJ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
