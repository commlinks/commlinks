...
@XmlRootElement(name = "LimitSubjectOfActivity101", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class LimitSubjectOfActivity101 {

    @XmlElement(name = "FobiddenDeals", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String fobiddenDeals;
    @XmlElement(name = "ForbiddenActivity", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String forbiddenActivity;
    @XmlElement(name = "FobiddenOperations", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
