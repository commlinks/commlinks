...
@XmlRootElement(name = "Suquestrators109", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Suquestrators109 {

    @XmlElement(name = "Suquestrator109", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
