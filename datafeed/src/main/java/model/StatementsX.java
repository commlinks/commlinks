...
@XmlRootElement(name = "StatementsX", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsX {

    @XmlElement(name = "StatementX", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
