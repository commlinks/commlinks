...
@XmlRootElement(name = "AddemptionOfTraderSeatChange", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class AddemptionOfTraderSeatChange {
    ...
    @XmlElement(name = "ForeignAuthority", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
