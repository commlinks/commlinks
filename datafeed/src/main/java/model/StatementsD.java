...
@XmlRootElement(name = "StatementsD", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsD {

    @XmlElement(name = "StatementD", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
