...
@XmlRootElement(name = "Branches804", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Branches804 {

    @XmlElement(name = "Branch804Subject", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class Branch804Subject {
        ...
        @XmlElement(name = "BranchSubject", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
        protected SubjectType branchSubject;
        @XmlElement(name = "Branches", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
