...
@XmlRootElement(name = "LeadingBoard", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class LeadingBoard {

    @XmlElement(name = "LeadingBoardMandate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected LeadingBoard.LeadingBoardMandate leadingBoardMandate;
    @XmlElement(name = "Leader", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
