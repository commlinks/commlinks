...
@XmlRootElement(name = "StatementsAM", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAM {

    @XmlElement(name = "StatementAM", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
