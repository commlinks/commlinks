...
@XmlRootElement(name = "StatementsZ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsZ {

    @XmlElement(name = "StatementZ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
