...
@XmlRootElement(name = "ReinstatementsDisallowPetitionThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class ReinstatementsDisallowPetitionThirdIns {

    @XmlElement(name = "ReinstatementDisallowPetitionThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class ReinstatementDisallowPetitionThirdIns {
        ...
        @XmlElement(name = "Petitioner", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
        ...
        @XmlElement(name = "InscribedAct", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
