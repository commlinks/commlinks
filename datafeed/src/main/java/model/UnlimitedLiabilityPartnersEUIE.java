...
@XmlRootElement(name = "UnlimitedLiabilityPartnersEUIE", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class UnlimitedLiabilityPartnersEUIE {

    @XmlElement(name = "UnlimitedLiabilityPartnerEUIE", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class UnlimitedLiabilityPartnerEUIE {
        ...
        @XmlElement(name = "NoObligationsEUIEText", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
        protected int noObligationsEUIEText;
        @XmlElement(name = "DateOfAcceptanceEUIE", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
