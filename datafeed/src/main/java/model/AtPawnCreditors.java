...
@XmlRootElement(name = "AtPawnCreditors", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class AtPawnCreditors {

    @XmlElement(name = "AtPawnCreditor", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
