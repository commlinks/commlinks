...
@XmlRootElement(name = "PledgeExecutionDepozitar", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class PledgeExecutionDepozitar {

    @XmlElement(name = "BIC", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected String bic;
    @XmlElement(name = "IBAN", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
