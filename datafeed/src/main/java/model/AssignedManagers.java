...
@XmlRootElement(name = "AssignedManagers", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class AssignedManagers {

    @XmlElement(name = "AssignedManager", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
