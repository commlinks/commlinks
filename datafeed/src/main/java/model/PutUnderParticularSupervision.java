...
@XmlRootElement(name = "PutUnderParticularSupervision", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class PutUnderParticularSupervision {

    @XmlElement(name = "Date", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected PutUnderParticularSupervision.Date date;
    @XmlElement(name = "Conditions", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
