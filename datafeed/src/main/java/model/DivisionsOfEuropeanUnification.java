...
@XmlRootElement(name = "DivisionsOfEuropeanUnification", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class DivisionsOfEuropeanUnification {

    @XmlElement(name = "DivisionOfEuropeanUnification", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class DivisionOfEuropeanUnification {
        ...
        @XmlElement(name = "ForeignCompanyBaseData", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
