...
@XmlRootElement(name = "Reinstatements", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Reinstatements {

    @XmlElement(name = "Reinstatement", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
