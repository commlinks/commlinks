...
@XmlRootElement(name = "StatementsH", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsH {

    @XmlElement(name = "StatementH", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
