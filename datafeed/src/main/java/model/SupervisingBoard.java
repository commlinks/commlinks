...
@XmlRootElement(name = "SupervisingBoard", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class SupervisingBoard {

    @XmlElement(name = "SupervisingBoardMandate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected SupervisingBoard.SupervisingBoardMandate supervisingBoardMandate;
    @XmlElement(name = "Supervisor", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
