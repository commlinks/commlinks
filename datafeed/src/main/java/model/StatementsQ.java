...
@XmlRootElement(name = "StatementsQ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsQ {

    @XmlElement(name = "StatementQ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
