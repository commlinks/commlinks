...
@XmlRootElement(name = "BoardOfDirectors", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class BoardOfDirectors {

    @XmlElement(name = "BoardOfDirectorsMandate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected BoardOfDirectors.BoardOfDirectorsMandate boardOfDirectorsMandate;
    @XmlElement(name = "Director", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
