...
@XmlRootElement(name = "StatementsF", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsF {

    @XmlElement(name = "StatementF", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
