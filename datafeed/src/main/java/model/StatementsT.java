...
@XmlRootElement(name = "StatementsT", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsT {

    @XmlElement(name = "StatementT", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
