...
@XmlRootElement(name = "StatementsAH", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAH {

    @XmlElement(name = "StatementAH", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
