...
@XmlRootElement(name = "StatementsV", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsV {

    @XmlElement(name = "StatementV", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
