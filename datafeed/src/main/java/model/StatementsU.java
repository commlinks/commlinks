...
@XmlRootElement(name = "StatementsU", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsU {

    @XmlElement(name = "StatementU", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
