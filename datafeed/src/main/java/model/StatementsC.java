...
@XmlRootElement(name = "StatementsC", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsC {

    @XmlElement(name = "StatementC", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
