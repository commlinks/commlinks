...
@XmlRootElement(name = "BoardOfManagers", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class BoardOfManagers {

    @XmlElement(name = "ManagerMandate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected BoardOfManagers.ManagerMandate managerMandate;
    @XmlElement(name = "BoardManager", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
