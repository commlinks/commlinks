...
@XmlRootElement(name = "TrusteesThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class TrusteesThirdIns {

    @XmlElement(name = "TrusteeThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
