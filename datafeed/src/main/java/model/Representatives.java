...
@XmlRootElement(name = "Representatives", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Representatives {

    @XmlElement(name = "Representative", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
