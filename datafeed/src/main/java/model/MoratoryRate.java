...
@XmlRootElement(name = "MoratoryRate", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class MoratoryRate {

    @XmlElement(name = "Price", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
    protected PriceType price;
    @XmlElement(name = "DateOfCalculation", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
