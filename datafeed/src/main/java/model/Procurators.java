...
@XmlRootElement(name = "Procurators", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class Procurators {

    @XmlElement(name = "Procurator", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
