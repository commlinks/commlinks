...
@XmlRootElement(name = "StatementsS", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsS {

    @XmlElement(name = "StatementS", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
