...
@XmlRootElement(name = "SuspendProceedingsThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class SuspendProceedingsThirdIns {
    ...
    @XmlElement(name = "SuspendReson", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
