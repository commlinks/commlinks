...
@XmlRootElement(name = "StatementsL", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsL {

    @XmlElement(name = "StatementL", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
