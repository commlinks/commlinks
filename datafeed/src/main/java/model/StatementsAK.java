...
@XmlRootElement(name = "StatementsAK", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAK {

    @XmlElement(name = "StatementAK", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
