...
@XmlRootElement(name = "StatementsG", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsG {

    @XmlElement(name = "StatementG", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
