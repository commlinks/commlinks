...
@XmlRootElement(name = "StatementsK", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsK {

    @XmlElement(name = "StatementK", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
