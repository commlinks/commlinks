...
@XmlRootElement(name = "NonMonetaryDeposits", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class NonMonetaryDeposits {

    @XmlElement(name = "NonMonetaryDeposit", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    ...
    public static class NonMonetaryDeposit {
        ...
        @XmlElement(name = "Description033", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields", required = true)
        ...
        @XmlElement(name = "OutgoingNumber", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
