...
@XmlRootElement(name = "StatementsAB", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAB {

    @XmlElement(name = "StatementAB", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
