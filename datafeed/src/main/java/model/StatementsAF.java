...
@XmlRootElement(name = "StatementsAF", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsAF {

    @XmlElement(name = "StatementAF", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
