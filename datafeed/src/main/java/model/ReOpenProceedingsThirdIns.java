...
@XmlRootElement(name = "ReOpenProceedingsThirdIns", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class ReOpenProceedingsThirdIns {

    @XmlElement(name = "Title", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected String title;
    @XmlElement(name = "ActData", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
    protected ActDataType actData;
    @XmlElement(name = "ReopeningReson", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
