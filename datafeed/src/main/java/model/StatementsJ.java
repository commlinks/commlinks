...
@XmlRootElement(name = "StatementsJ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
public class StatementsJ {

    @XmlElement(name = "StatementJ", namespace = "http://www.registryagency.bg/schemas/deedv2/Fields")
